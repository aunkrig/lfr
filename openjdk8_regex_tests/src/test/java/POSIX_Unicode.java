...
final public class POSIX_Unicode {
    ...
    public static boolean isBlank(int ch) {
        ...
        return POSIX_Unicode.isSpace(ch) &&
    ...
    public static boolean isPrint(int ch) {
        return (POSIX_Unicode.isGraph(ch) || POSIX_Unicode.isBlank(ch)) && !POSIX_Unicode.isCntrl(ch);
    }
    ...
    public static boolean isWord(int ch) {
        return POSIX_Unicode.isAlpha(ch) ||
               ((((1 << Character.NON_SPACING_MARK) |
                  (1 << Character.ENCLOSING_MARK) |
                  (1 << Character.COMBINING_SPACING_MARK) |
                  (1 << Character.CONNECTOR_PUNCTUATION)) >> Character.getType(ch)) & 1)
               != 0 ||
               POSIX_Unicode.isDigit(ch) ||
               POSIX_Unicode.isJoinControl(ch);
    }
}
